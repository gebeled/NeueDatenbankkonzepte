    ...
    <div className="px-4 sm:px-6 flex justify-center">
      <Card className="w-full max-w-[1200px]">
        ...
        {showRouts && (
          ...
          {routes.length === 0 ? (
              <p>Es konnte leider keine passende Routen gefunden werden. Bitte versuche eine andere Kombination.</p>
          ) : (
...
// von vorhin wenn man nichts ändert an der Version zur SIcherheit hier mal so gespeichert
/*
"use client";
